...
import org.karamelsoft.axon.quiz.interfaces.http.handleStatus
import org.karamelsoft.axon.quiz.services.customers.api.CorrectCustomerAddress
import org.karamelsoft.axon.quiz.services.customers.api.CorrectCustomerDetails
import org.karamelsoft.axon.quiz.services.customers.api.CustomerId
import org.karamelsoft.axon.quiz.services.customers.api.RegisterUniqueCustomer
import org.karamelsoft.axon.quiz.views.customer.dashboard.api.CustomerDashboardResponse
import org.karamelsoft.axon.quiz.views.customer.dashboard.api.GetCustomerDashboard
...
class CustomerController(
    ...
    fun getCustomerDashboard(@PathVariable("customerId") customerId: String): Mono<CustomerDashboardResponse> {
        return queryGateway.query(
            GetCustomerDashboard(org.karamelsoft.axon.quiz.views.customer.dashboard.api.CustomerId.from(customerId)),
