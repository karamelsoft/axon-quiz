...
import org.karamelsoft.axon.quiz.services.accounts.api.AccountOwner
import org.karamelsoft.axon.quiz.services.cards.api.CardId
import org.karamelsoft.axon.quiz.services.cards.api.CardOwner
...
fun CustomerDashboardRepository.findByCustomer(customerId: org.karamelsoft.axon.quiz.views.customer.dashboard.api.CustomerId) = this.findByCustomerId(customerId.value.toString())
