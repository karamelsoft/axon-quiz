package org.karamelsoft.axon.quiz.views.customer.dashboard.query.domain
...
import org.karamelsoft.axon.quiz.views.customer.dashboard.api.AccountStatus
import org.karamelsoft.axon.quiz.views.customer.dashboard.api.CustomerAddress
import org.karamelsoft.axon.quiz.views.customer.dashboard.api.CustomerDetails
...
data class CustomerDashboard(
    ...
    fun toQueryAPI() = org.karamelsoft.axon.quiz.views.customer.dashboard.api.CustomerDashboard(
        id = id,
...
data class CustomerProjection(
    ...
    fun toQueryAPI() = org.karamelsoft.axon.quiz.views.customer.dashboard.api.CustomerProjection(
...
data class AccountProjection(
    ...
    fun toQueryAPI() = org.karamelsoft.axon.quiz.views.customer.dashboard.api.AccountProjection(
        status = status,
        balance = balance,
        creationTimestamp = creationTimestamp,
        lastModificationTimestamp = lastModificationTimestamp
...
data class CardProjection(
    ...
    fun toQueryAPI() = org.karamelsoft.axon.quiz.views.customer.dashboard.api.CardProjection(
...
enum class CardStatus {
    ...
    fun toQueryAPI() = org.karamelsoft.axon.quiz.views.customer.dashboard.api.CardStatus.valueOf(name)
}
